...
namespace InternPortal.Infrastructure.Migrations
{
    ...
    [Migration("20260630115132_AddManagerWorkFlow")]
    partial class AddManagerWorkFlow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternPortal.Domain.Entities.KanbanBoardTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("KanbanBoardTemplates");
                });
            ...
            modelBuilder.Entity("InternPortal.Domain.Entities.KanbanTemplateTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InternPortal.Domain.Entities.TaskActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InternPortal.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("ManagedDepartment")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InternPortal.Domain.Entities.KanbanBoardTemplate", b =>
                {
                    b.HasOne("InternPortal.Domain.Entities.User", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("InternPortal.Domain.Entities.KanbanTemplateTask", b =>
                {
                    b.HasOne("InternPortal.Domain.Entities.KanbanBoardTemplate", "Template")
                        .WithMany("Tasks")
